...
namespace Sando.Indexer.Documents
{
	public class EnumDocument : SandoDocument
	{
        ...
        public override List<Field> GetFieldsForLucene()
        {
            ...
            fields.Add(new Field(SandoField.Namespace.ToString(), enumElement.Namespace, Field.Store.YES, Field.Index.ANALYZED));
            AddBodyField(fields, new Field(SandoField.Body.ToString(), enumElement.RawSource, Field.Store.NO, Field.Index.ANALYZED));
            ...
            AddBodyField(fields, new Field(SandoField.Body.ToString(), enumElement.Body, Field.Store.NO, Field.Index.ANALYZED));
            return fields;
		}
