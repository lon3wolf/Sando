...
namespace Sando.Indexer.Documents
{
	public class MethodPrototypeDocument : SandoDocument
	{
        ...
        public override List<Field> GetFieldsForLucene()
        {
            ...
            fields.Add(new Field(SandoField.Arguments.ToString(), methodPrototypeElement.Arguments, Field.Store.YES, Field.Index.ANALYZED));
            AddBodyField(fields, new Field(SandoField.Body.ToString(), methodPrototypeElement.RawSource, Field.Store.NO, Field.Index.ANALYZED));
            fields.Add(new Field(SandoField.ReturnType.ToString(), methodPrototypeElement.ReturnType, Field.Store.YES, Field.Index.ANALYZED));
