...
namespace Sando.Indexer.Documents
{
	public class PropertyDocument : SandoDocument
	{
        ...
        public override List<Field> GetFieldsForLucene()
        {
            ...
            AddBodyField(fields, new Field(SandoField.Body.ToString(), propertyElement.Body, Field.Store.NO, Field.Index.ANALYZED));
            fields.Add(new Field(SandoField.DataType.ToString(), propertyElement.PropertyType, Field.Store.YES, Field.Index.ANALYZED));
            ...
            fields.Add(new Field(SandoField.ClassName.ToString(), propertyElement.ClassName, Field.Store.YES, Field.Index.ANALYZED));
