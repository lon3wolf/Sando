...
namespace Sando.Indexer.Documents
{
	public class MethodDocument : SandoDocument
	{
        ...
        public override List<Field> GetFieldsForLucene()
		{
            ...
            fields.Add(new Field(SandoField.Arguments.ToString(), methodElement.Arguments, Field.Store.YES, Field.Index.ANALYZED));
            AddBodyField(fields, new Field(SandoField.Body.ToString(), methodElement.Body, Field.Store.NO, Field.Index.ANALYZED));
            fields.Add(new Field(SandoField.ClassId.ToString(), methodElement.ClassId.ToString(), Field.Store.YES, Field.Index.NOT_ANALYZED));
            fields.Add(new Field(SandoField.ClassName.ToString(), methodElement.ClassName, Field.Store.YES, Field.Index.ANALYZED));
            fields.Add(new Field(SandoField.ReturnType.ToString(), methodElement.ReturnType, Field.Store.YES, Field.Index.ANALYZED));
